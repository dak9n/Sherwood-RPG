...
CELL = 32
# Ширина брони на герое: фас/спина и профиль.
#
# Подобрано по макету на КАДРАХ ХОДЬБЫ, а не на статичной позе: 14 сидит ровно
# по торсу, но деталей почти не остаётся; 16 шире плеч — и это правильно, броня
# и должна ложиться наплечниками на плечи, при этом лицо открыто; с 18 начинает
# съедать подбородок, с 20 герой пропадает внутри брони.
W_FRONT = 16
W_SIDE = 12
