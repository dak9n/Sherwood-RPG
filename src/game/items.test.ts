...
test('в игре ровно шесть шлемов helm1..helm6, все со слотом helm', () => {
  ...
  // Плюс шлем комплекта Vanguard — нарезан из new-armor/armor1.png.
  assert.deepEqual(helms, ['helm1', 'helm2', 'helm3', 'helm4', 'helm5', 'helm6', 'vanguard_helm'], 'других шлемов быть не должно');
});
